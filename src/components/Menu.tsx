...
const routes = {
  appPages: [
    { title: 'Calendario', path: '/tabs/schedule', icon: calendarOutline },
    { title: 'Ponentes', path: '/tabs/speakers', icon: peopleOutline },
    { title: 'Mapa', path: '/tabs/map', icon: mapOutline },
    { title: 'Acerca de ...', path: '/tabs/about', icon: informationCircleOutline }
  ],
  loggedInPages: [
  ...
  loggedOutPages: [
    ...
    { title: 'Soporte', path: '/support', icon: help },
    { title: 'Registrar', path: '/signup', icon: personAdd }
  ]
};
