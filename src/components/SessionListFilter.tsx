      ...
      <IonHeader translucent={true} className="session-list-filter">
        <IonToolbar>
          <IonButtons slot="start">
            ...
            { !ios &&
              <IonButton onClick={handleDeselectAll}>Limpiar</IonButton>
            }
          </IonButtons>
          ...
          <IonButtons slot="end">
            <IonButton onClick={onDismissModal} strong>Hecho</IonButton>
          </IonButtons>
        </IonToolbar>
      </IonHeader>
      ...
      { ios &&
        <IonFooter>
          <IonToolbar>
            ...
            <IonButtons slot="end">
              <IonButton onClick={handleSelectAll}>Seleccionar todo</IonButton>
            </IonButtons>
          </IonToolbar>
        </IonFooter>
      }
